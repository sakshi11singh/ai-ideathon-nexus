...
const TeamCard = ({
  ...
  return (
    <div className="glass-card p-6 hover-glow group">
      ...
      {bio && (
        <p className="text-muted-foreground text-sm text-center mb-4">{bio}</p>
      )}
      ...
      {social && (
        <div className="flex justify-center gap-3 mt-4">
          {social.linkedin && (
            ...
            >
              <svg className="w-5 h-5 text-muted-foreground hover:text-primary" fill="currentColor" viewBox="0 0 24 24">
